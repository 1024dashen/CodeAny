        ...
        <div class="preview-modes">
            ...
            >
                ...
                >
                    <path
                        v-if="mode.id === 'phone'"
                        d="M8 3h8a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z M11 18h2"
                    />
                    <path
                        v-else-if="mode.id === 'ipad'"
                        d="M5 4h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z M11 17h2"
                    />
                    ...
                    <template v-else>
                        ...
                        <path
                            d="M3 12h18 M12 3a14 14 0 0 1 0 18 M12 3a14 14 0 0 0 0 18"
                        />
                    </template>
                </svg>
...
const previewModes = computed(() => [
    {
        id: 'phone' as PreviewMode,
        label: t('preview.phoneTitle'),
        shortLabel: t('preview.phone'),
    },
    {
        id: 'ipad' as PreviewMode,
        label: t('preview.ipadTitle'),
        shortLabel: t('preview.ipad'),
    },
    {
        id: 'desktop' as PreviewMode,
        label: t('preview.desktopTitle'),
        shortLabel: t('preview.desktop'),
    },
    {
        id: 'browser' as PreviewMode,
        label: t('preview.browserTitle'),
        shortLabel: t('preview.browser'),
    },
])
